...
public class AppRoleRole
{
    ...
    /// </summary>
    [JsonProperty("token_blound_cidrs")] public string[] token_blound_cidrs = Array.Empty<string>();
    ...
    /// </summary>
    [JsonProperty("token_policies")] public string[] token_policies = Array.Empty<string>();
